...
- [x] Stories de 19 componentes (15 UI components + 3 features + 1 integração) — removidos 2 componentes com dependências Firebase
  - **Components Section (15):** Avatar, Badge, Button, Card, Checkbox, Dialog, DropdownMenu, Input, Label, Separator, Sheet, Sooner, Switch, Toast, Tooltip
...
- [x] Storybook rodando em http://localhost:6008 com hot reload (Next.js framework)
- [x] Todos os 19 componentes renderizando sem erros; controls e documentation working
