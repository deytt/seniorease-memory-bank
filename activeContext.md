...
> Última atualização: 2026-07-01 (Evolução do Módulo Lembretes: headers alinhados a Tarefas, 5 categorias em combo, filtros combináveis Categoria+"Hoje", validação de data e Tour Guiado; próximo: Histórico e pendências na Segurança — biometria e alterar senha)
